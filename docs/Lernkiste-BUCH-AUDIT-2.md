...
| **B12** Der Kapitelstreifen wächst mit jeder Ebene | **erledigt** (v429). Gemessen an einem Profil mit Fortschritt auf allen Ebenen: **17 Reiter, 12 sichtbar, 109 von 390 Punkten** — auf dem Zielgerät, nicht in einem Randfall. Jetzt ein Reiter je **Welt** (aus `weltVon`, derselben Regel wie die Weltenwahl): 6 Reiter, alle sichtbar, 62 Punkte. Darin der Bau des Tierkapitels — Raster aus Ebenenzellen, ein Tipp öffnet die Ebene, ein Pfeil zurück; keine zweite Reiterzeile. Geprüft wird die FORM der Kennung („jeder Reiter ist eine Welt oder eines der drei festen Kapitel"), nicht eine Obergrenze — eine Zahl wäre mit dem nächsten Profil wieder falsch. |
| **B12b** Auf 390 Punkten steht ein Reiter von sechs außerhalb | **offen**. 6 × 66 Punkte (der Boden aus `min-width`) sind 396 auf einem 390 Punkte breiten Schirm — es fehlt buchstäblich ein Reiter breit. Zu holen über einen niedrigeren Boden im Hochformat; ob 60 Punkte noch mit dem Daumen zu treffen sind, ist eine Messung. |
| **B13** Der Abzeichenname bricht mitten im Wort | **erledigt** (v431). Hochkant war die Zelle 114 breit, davon **90 innen** — „Bundesländer" braucht 94,3, „Siebenerreihe" 94,1, „Stadtstaaten" 90,3. Die Spalte steht jetzt auf 119 = 95 für den Namen plus 24 Polster. Geprüft werden alle 16 möglichen Namen aus `TAFEL`, nicht die sichtbaren. |
| **B14** Die Weltübersicht ist mit wenigen Ebenen dünn | **erledigt** (v431). Gemessen 28 % (Erdkunde) und 34 % (Schreiben). Zwei Ursachen: `auto-fill` ließ leere Spalten stehen (zwei Ebenen als Briefmarken links oben, Umriss 34 px) und die Seite sagte nichts, was nicht schon auf dem Reiter stand. Jetzt `auto-fit` (Umriss 56/72 px) und ein Wegweiser „Als Nächstes hier: … Noch N." samt hervorgehobener Zelle. Danach **46 %** und **53 %**. |
